...
export const editableRootStyle = {
  '--slot4-page-bg': '#f4f6f6',
  '--slot4-page-text': '#183035',
  '--slot4-panel-bg': '#eef1f1',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f6b73',
  '--slot4-soft-muted-text': '#78838a',
  '--slot4-accent': '#08b3a5',
  '--slot4-accent-fill': '#08b3a5',
  '--slot4-accent-soft': '#d9f5f2',
  '--slot4-dark-bg': '#064653',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe8e8',
  '--slot4-cream': '#f4f6f6',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#08b3a5',
  '--slot4-gray': '#eef1f1',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f4f6f6 54%, #eef1f1 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-black leading-[0.98] sm:text-6xl lg:text-[4.6rem]',
  ...
  button: {
    ...
    secondary: `inline-flex items-center justify-center gap-2 border border-black/20 bg-white px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-[var(--slot4-dark-bg)] transition hover:bg-[var(--slot4-dark-bg)] hover:text-white`,
    accent: `inline-flex items-center justify-center gap-2 bg-[var(--slot4-accent-fill)] px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-[var(--slot4-dark-bg)]`,
  },
  media: {
...
export const aiLayoutRules = [
  ...
  'Use a media-distribution style white masthead, teal contact strip, deep blue action buttons, and image-led logistics sections.',
