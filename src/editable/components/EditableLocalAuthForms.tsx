...
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center bg-[var(--slot4-dark-bg)] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-[var(--slot4-accent)] disabled:opacity-60'
